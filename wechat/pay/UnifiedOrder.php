...
class UnifiedOrder extends RequestPay
{
    ...
    function createXml()
    {
        ...
        }elseif ($this->parameters["trade_type"] == "NATIVE" &&
            $this->parameters["product_id"] == NULL){
            throw new WechatException("统一支付接口中，缺少必填参数product_id！trade_type为NATIVE时，product_id为必填参数！"."<br>");
        }
        ...
        $resultsXml =  $this->arrayToXml($this->parameters);
        return $resultsXml;
    }
